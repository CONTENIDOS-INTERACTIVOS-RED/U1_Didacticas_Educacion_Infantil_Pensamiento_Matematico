        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La unidad aborda el pensamiento matemático en la infancia como base del desarrollo cognitivo. Explora la lógica como fundamento del aprendizaje numérico y describe cómo los niños construyen nociones de número, cantidad, orden y cardinalidad mediante el juego, la exploración y la interacción social. Se analiza la influencia de las áreas del desarrollo infantil (cognitiva, socioemocional y motriz) y se proponen estrategias pedagógicas para potenciar habilidades matemáticas desde los primeros años. La unidad destaca el valor del entorno y el juego como medios clave para fomentar un aprendizaje significativo y contextualizado.
